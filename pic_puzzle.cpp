...
int main()
{
	...
	auto front = Scene::create("矫累", "Images/矫累拳搁.png");
	auto home = Scene::create("霸烙 急琶", "Images/权拳搁.png");
	auto scene = Scene::create("4 X 4", "Images/炉备后硅版.jpg");
	auto scene2 = Scene::create("3 X 3", "Images/炉备具备后硅版.jpg");
	...
	Piece piece[16] = {
		{"Images/炉备1.png", 0, scene, piece1_posX, piece1_posY},
		{"Images/炉备2.png", 1, scene, piece1_posX + piece_size, piece1_posY},
		{"Images/炉备3.png", 2, scene, piece1_posX + piece_size * 2, piece1_posY},
		{"Images/炉备4.png", 3, scene, piece1_posX + piece_size * 3, piece1_posY},
		{"Images/炉备5.png", 4, scene, piece1_posX, piece1_posY - piece_size},
		{"Images/炉备6.png", 5, scene, piece1_posX + piece_size, piece1_posY - piece_size},
		{"Images/炉备7.png", 6, scene, piece1_posX + piece_size * 2, piece1_posY - piece_size},
		{"Images/炉备8.png", 7, scene, piece1_posX + piece_size * 3, piece1_posY - piece_size},
		{"Images/炉备9.png", 8, scene, piece1_posX, piece1_posY - piece_size * 2},
		{"Images/炉备10.png", 9, scene, piece1_posX + piece_size, piece1_posY - piece_size * 2},
		{"Images/炉备11.png", 10, scene, piece1_posX + piece_size * 2, piece1_posY - piece_size * 2},
		{"Images/炉备12.png", 11, scene, piece1_posX + piece_size * 3, piece1_posY - piece_size * 2},
		{"Images/炉备13.png", 12, scene, piece1_posX, piece1_posY - piece_size * 3},
		{"Images/炉备14.png", 13, scene, piece1_posX + piece_size, piece1_posY - piece_size * 3},
		{"Images/炉备15.png", 14, scene, piece1_posX + piece_size * 2, piece1_posY - piece_size * 3},
		{"Images/炉备16.png", 15, scene, piece1_posX + piece_size * 3, piece1_posY - piece_size * 3},
	};

	Piece piece2[9] = {
		{"Images/炉备具备1.png", 0, scene2, piece1_posX2, piece1_posY2},
		{"Images/炉备具备2.png", 1, scene2, piece1_posX2 + piece_size2, piece1_posY2},
		{"Images/炉备具备3.png", 2, scene2, piece1_posX2 + piece_size2 * 2, piece1_posY2},
		{"Images/炉备具备4.png", 3, scene2, piece1_posX2, piece1_posY2 - piece_size2},
		{"Images/炉备具备5.png", 4, scene2, piece1_posX2 + piece_size2, piece1_posY2 - piece_size2},
		{"Images/炉备具备6.png", 5, scene2, piece1_posX2 + piece_size2 * 2, piece1_posY2 - piece_size2},
		{"Images/炉备具备7.png", 6, scene2, piece1_posX2, piece1_posY2 - piece_size2 * 2},
		{"Images/炉备具备8.png", 7, scene2, piece1_posX2 + piece_size2, piece1_posY2 - piece_size2 * 2},
		{"Images/炉备具备9.png", 8, scene2, piece1_posX2 + piece_size2 * 2, piece1_posY2 - piece_size2 * 2},
	};
	...
	auto completePuzzle = Object::create("Images/炉备硅版.png", scene, 0, 0);
	auto completePuzzle2 = Object::create("Images/炉备具备硅版.png", scene2, 0, 0);

	auto fail = Object::create("Images/角菩.png", scene, 0, 0, false);
	auto fail2 = Object::create("Images/角菩2.png", scene2, 0, 0, false);
